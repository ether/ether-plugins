...
(function (glob) {
  ...
  TextStatistics.prototype.averageSyllablesPerWord = function (text) {
    text = text ? cleanText(text) : this.text;
    let syllableCount = 0; const wordCount = this.wordCount(text); const
      self = this;
  ...
  (typeof module !== 'undefined' && module.exports) ? (module.exports = textStatistics) : (typeof define !== 'undefined' ? (define('textstatistics', [], () => textStatistics)) : (glob.textstatistics = textStatistics));
})(this);
